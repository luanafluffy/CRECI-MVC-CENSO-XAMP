<main class="content">
    ...
    <form method="POST" action="/sistema-creci/controle_censo.php">
        <!-- Pesquisando dados -->
        <div>
    ...
    <form method="POST" action="/sistema-creci/status_censo.php" >
        <!-- Dados filtrados -->
    ...
    <form method="POST" action="sistema-creci/status_censo.php" >
        <div>
            ...
            <input type="submit" action="/status_censo.php" name="botao" value="Atualizar Status 1">
        </div>
    </form>
</main>
