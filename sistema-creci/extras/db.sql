CREATE TABLE DB_CENSO.dbo.censos (
...
CREATE TABLE DB_CENSO.dbo.usuarios (
	id INT IDENTITY  PRIMARY KEY NOT NULL, 
...
INSERT INTO DB_CENSO.dbo.usuarios (nome_usuario, nome_completo, setor, senha)
...
INSERT INTO DB_CENSO.dbo.usuarios (nome_usuario, nome_completo, setor, senha, ultimo_logout_hora, ultimo_logout_data, ultimo_login_hora, ultimo_login_data)
...
INSERT INTO DB_CENSO.dbo.censos (
